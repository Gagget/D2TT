...
struct Control {
   ...
   DWORD _3;						//0x20
   DWORD _4;						//0x24
   VOID (__fastcall *CallFunc)(DWORD unk,DWORD unk2,Control **pControl);//0x28  //Button
   DWORD _6;						//0x2C
   DWORD *_7;						//0x30
   VOID (__fastcall *CallBackFunc)(/*D2MSG* pD2MSG*/ unsigned long *pD2MSG);//0x34
   DWORD _9;                        //0x38
   Control* pNext;					//0x3C
   DWORD _10;						//0x40
   union {
	   DWORD dwMaxLength;				//0x44 
	   bool ButtonFlag_I;               //0x44
   };
   union {
	   ControlText* pFirstText;		//0x48
	   DWORD dwScrollEntries;		//0x48
	   bool ButtonFlag_II;           //0x48
   };
   union {
...
struct ControlFont{
	unsigned long FontSize;			//0x00
	unsigned long Unk;				//0x04
	unsigned long FontSize2;		//0x08
};

struct ListScroll{
	unsigned long xpos;				//0x00
	unsigned long ypos;				//0x04
	unsigned long distanceUp;		//0x08
};

struct Fontx{
	unsigned char afont;	//0x00
	unsigned char dwUnk;	//0x01
	unsigned char dwUnk2;	//0x02
	unsigned char Width;	//0x03
	unsigned char Height;	//0x04
};
